...
%global maj_ver 2
%global min_ver 4
%global patch_ver 110
%global commit d76c387125c7ad336f39121b9c3148361731bdad
...
Source0:        %url/drm/-/archive/%name-%{maj_ver}.%{min_ver}.%{patch_ver}/drm-%name-%{maj_ver}.%{min_ver}.%{patch_ver}.tar.gz
Source1:        README.rst
...
%prep
%autosetup -n drm-%name-%{maj_ver}.%{min_ver}.%{patch_ver} -p1
